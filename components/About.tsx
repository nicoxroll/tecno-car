...
const About: React.FC = () => {
  ...
  const getIcon = (iconName: string) => {
    switch (iconName) {
      case 'Wind': return <Wind size={18} strokeWidth={1} />;
      case 'Coffee': return <Coffee size={18} strokeWidth={1} />;
      case 'Wifi': return <Wifi size={18} strokeWidth={1} />;
      case 'Tv': return <Tv size={18} strokeWidth={1} />;
      case 'CheckCircle': return <CheckCircle size={18} strokeWidth={1} />;
      default: return <CheckCircle size={18} strokeWidth={1} />;
    }
  };
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2 order-2 lg:order-1">
            ...
            <p className="text-zinc-300 font-light text-sm leading-loose mb-8 text-justify" dangerouslySetInnerHTML={{ __html: aboutDescription1 }}></p>
