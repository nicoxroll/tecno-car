        ...
        >
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                ...
                <h3 className="text-3xl font-light text-white mb-2 uppercase tracking-tight">{selectedProduct.name}</h3>
                <p className="text-xl font-medium text-white mb-6">${selectedProduct.price.toLocaleString()}</p>
